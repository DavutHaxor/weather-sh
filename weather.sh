...
if $display_rain_1h; then
  echo -n "Rain for the last 1 hour is " && (jq -rj 'main.rain.1h') && echo " mm"
fi

if $display_rain_3h; then
  echo -n "Rain for the last 3 hours is " && (jq -rj 'main.rain.3h') && echo " mm"
fi

if $display_snow_1h; then
  echo -n "Snow for the last 1 hour is " && (jq -rj 'main.snow.1h') && echo " mm"
fi

if $display_snow_3h; then
  echo -n "Snow for the last 3 hour is " && (jq -rj 'main.snow.3h') && echo " mm"
fi
